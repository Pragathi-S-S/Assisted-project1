...
public class FinalAssessment {
	...
	scanner.nextLine().toLowerCase().trim().toCharArray(); 
	 ...
	 System.out.println("data " + filename + " already exists at "
	+ folder_name); 
	 return; 
	 } 
	 } 
	 ...
	 System.out.println("data " + filename + " deleted from " + 
	folder_name); 
	 return; 
	 } 
	 } 
	 ...
	 System.out.println("Developer Name:Pragathi S S"+ WELCOME_PROMPT); 
	 FinalAssessment menu = new FinalAssessment(); 
